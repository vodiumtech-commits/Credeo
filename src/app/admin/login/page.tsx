...
import { Shield, Eye, EyeOff, Lock, Mail, ArrowLeft, Loader2 } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-vodium-charcoal rounded-2xl border border-white/[0.08] p-10 shadow-[0_0_60px_rgba(201,169,97,0.08)]">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-vodium-gold text-xs tracking-[0.3em] uppercase font-medium mb-1.5">Admin Console</p>
            <h1 className="font-serif text-2xl text-vodium-cream text-center">Vodium Ledger</h1>
            <p className="text-vodium-cream/30 text-xs mt-1.5">Restricted access — authorised personnel only</p>
          </div>

          {/* Mode tabs */}
          <div className="flex bg-black/30 border border-white/[0.06] rounded-xl p-1 mb-7">
            <button
              onClick={() => { setMode("super"); setError(null); }}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode === "staff" && (
              <div>
                ...
                <div className="relative">
                  <Mail size={14} className="absolute left-4 top-1/2 -translate-y-1/2 text-vodium-cream/30 pointer-events-none" />
                  <input
                    type="email"
                    value={email}
            ...
            >
              {loading ? (
                ...
                mode === "super" ? "Sign in to Admin Console" : "Sign in"
              )}
            </button>
          </form>
        </div>
        ...
        <div className="flex justify-center mt-6">
          <Link href="/" className="flex items-center gap-1.5 text-vodium-cream/25 hover:text-vodium-cream/55 text-xs transition-colors">
